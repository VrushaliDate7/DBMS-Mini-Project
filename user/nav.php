...
<nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
    ...
    <div class="navbar-header">
       <!--  <button type="button" class="navbar-toggle" data-toggle="collapse" data-target=".navbar-ex1-collapse">
        ...
        <a class="navbar-brand" href="index.php"><i class="fa fa-bolt"></i> BILJI</a> 
    </div>
    <!-- /.navbar-header -->
...
<?php 
    require_once 'C:\wamp64\www\ebill-master\Includes\user.php';
    $id=$_SESSION['uid'];
    $result = retrieve_user_details($id);
